...
export default function (data) {
  return data.results
    ...
    .map(({ backdrop_path, original_title, vote_average, overview, id }) => {
      ...
      <picture>
        <source srcset="https://image.tmdb.org/t/p/original${backdrop_path}" media="(min-width: 1280px)" />
        <source srcset="https://image.tmdb.org/t/p/w768${backdrop_path}" media="(min-width: 768px)" />
        <source srcset="https://image.tmdb.org/t/p/w480${backdrop_path}" media="(max-width: 767px)"
